#!/usr/bin/env python3
"""
Вводные для игры лабиринт.
Содержит карту комнат, описания команд и другие неизменяемые данные.
"""
...
COMMANDS = {
    "go": "Перейти в другую комнату (использование: идти <направление>)",
    "look": "Осмотреть текущую комнату",
    "help": "Показать доступные команды",
    "quit": "Выйти из игры",
    "take": "Взять предмет из комнаты (использльзование: взять <предмет>)",
    "inventory": "Показать инвентарь",
    "slove": "Попытаться решить загадку (использование: решить <ответ>)",
    "state": "Показать текущее состояние игрока"
}

...
COMMANDS = {
    "go": "Перейти в другую комнату (использование: go <направление>)",
    "look": "Осмотреть текущую комнату", 
    "help": "Показать доступные команды",
    "quit": "Выйти из игры",
    "take": "Взять предмет из комнаты (использование: take <предмет>)",
    "inventory": "Показать ваш инвентарь",
    "use": "Использовать предмет (использование: use <предмет>)",
